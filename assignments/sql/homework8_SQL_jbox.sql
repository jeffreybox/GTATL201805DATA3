-- GT Data Science Homework 8
-- Jeff Box | 8-7-18
-- sakila database: https://dev.mysql.com/doc/index-other.html
...
-- 67405.56 = Store sum
-- 67406.56 = Genre sum 
-- The payment table contains 5 retails without rental ideas that sum to 9.95 thereby reconciling this difference
-- In the future, the structure/schema should change to not be dependant on these values as a key.
